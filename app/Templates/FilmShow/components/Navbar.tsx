...
const Navbar = () => {
  ...
  return (
    <nav className="relative z-50 w-full bg-black/40 backdrop-blur-2xl border-b border-white/5 shadow-2xl shadow-black/50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <div className="hidden md:flex items-center space-x-1 rtl:space-x-reverse">
            <Link
              href="/"
              className="px-4 py-2 text-black hover:text-white font-medium rounded-lg hover:bg-white/5 hover:shadow-[0_0_20px_rgba(255,255,255,0.05)] transition-all duration-200"
            >
              خانه
            </Link>
            <Link
          ...
          <div className="flex items-center gap-4">
            <button
              className="p-2.5 text-black hover:text-white rounded-full hover:bg-white/5 hover:shadow-[0_0_25px_rgba(255,255,255,0.05)] transition-all duration-200"
              aria-label="جستجو"
            >
              <Search size={22} />
            </button>
            ...
            <button
              onClick={toggleMenu}
              className="md:hidden p-2 rounded-md text-black hover:text-white hover:bg-white/5 transition-colors"
              aria-label="منو"
            >
      ...
      >
        <div className="px-4 pt-4 pb-8 space-y-2 bg-black/60 backdrop-blur-2xl border-t border-white/5">
          <Link
            href="/"
            className="block text-black hover:text-white text-lg font-medium px-4 py-3 rounded-xl hover:bg-white/5 transition-all"
            onClick={toggleMenu}
          >
            خانه
          </Link>
